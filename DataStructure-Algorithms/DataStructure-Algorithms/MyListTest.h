...
void mylist_test() {
  ...
  /*²âÊÔµü´úÆ÷²Ù×÷*/
  std::cout << "µü´úÆ÷²Ù×÷" << std::endl;
  std::cout << std::endl;

  std::cout << "²âÊÔpush_back()" << std::endl;
  for (int i = 1; i < 10; i++) {
    mylist.push_back(i);
  }
  mylist.printInfo();
  ...
  std::cout << "²âÊÔpush_front()" << std::endl;
  for (int i = 1; i < 10; i++) {
    mylist.push_front(-i);
  }
  mylist.printInfo();
  ...
  std::cout << "²âÊÔinsert(iterator,data)" << std::endl;
  int c = mylist.size() / 2;
  ...
  std::cout << "²âÊÔerase(iterator)" << std::endl;
  auto itr2 = mylist.erase(mylist.begin());
  mylist.erase(itr2);
  mylist.printInfo();
  std::cout << std::endl;

  std::cout << "²âÊÔerase(iterator1,iterator2)" << std::endl;
